...
// Leadline analyzes Java/JS/TS/TSX/C++/Rust only. The hook skips the analyzer when
...
const LEADLINE_EXTENSIONS = [".java", ".js", ".jsx", ".ts", ".tsx", ".h", ".cpp", ".cc", ".cxx", ".hpp", ".hh", ".hxx", ".rs"] as const;
  ...
  async setup(ctx) {
    ...
    await ctx.tool.transform((editor) => {
      editor.add({
        ...
        description: "Call after editing Java/JS/TS/TSX/Rust, fixing bugs, refactoring, or before committing to spot complexity regressions vs a git base.",
        input: {
          type: "object",
          properties: {
