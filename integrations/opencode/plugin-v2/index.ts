...
// Leadline analyzes C/C++/Go/Java/JS/TS/TSX/Zig/Rust/Python only. The hook skips the analyzer when
...
const LEADLINE_EXTENSIONS = [".c", ".cc", ".cjs", ".cpp", ".cts", ".cxx", ".go", ".h", ".hh", ".hpp", ".hxx", ".java", ".js", ".jsx", ".mjs", ".mts", ".py", ".rs", ".ts", ".tsx", ".zig"] as const;
