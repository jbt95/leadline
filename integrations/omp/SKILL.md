...
only adds OMP trigger notes; do not fork the policy here.
...
- Where this native extension is not installed, the `leadline mcp` server
  is the supported fallback for the same analysis.
