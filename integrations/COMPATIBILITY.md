...
|---|---|---|---|---|---|---|---|---|
| Claude Code | Yes | Yes | Yes | Yes | Yes | block (Stop hook maps any gate failure to exit 2) | Plugin + MCP + skill + optional hooks | Not yet validated live |
...
| Gemini CLI | Yes | Yes | Yes | Yes | Extension | block (AfterAgent gate exits 2 on findings or an unavailable scanner) | Gemini extension | Not yet validated live |
